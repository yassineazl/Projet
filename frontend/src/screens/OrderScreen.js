        ...
        <Col md={8}>
          <ListGroup variant='flush'>
            <ListGroup.Item>
              ...
              {order.isDelivered ? (
                <Message variant='success'>
                  Remis le {order.deliveredAt.split('T')[0]}
                </Message>
              ) : (
                <Message variant='danger'>Non livrés
                </Message>
              )}
            </ListGroup.Item>
            ...
            <ListGroup.Item>
              ...
              {order.isPaid ? (
                <Message variant='success'>Payé à la livraison {order.paidAt}</Message>
              ) : (
                <Message variant='danger'>Payé à la livraison</Message>
              )}
            </ListGroup.Item>
